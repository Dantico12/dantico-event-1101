...
if (isset($_GET['event_id'])) {
    ...
    $error_message = "No event selected. Please select an event.";
    exit;
}
...
// Fetch event details
$event_sql = "SELECT event_name, event_code FROM events WHERE id = ?";
...
$_SESSION['current_event_code'] = $event_row['event_code'];
...
<nav class="sidebar" <?= !hasAccess(['Admin', 'Organizer', 'Member', 'Chairman', 'Secretary', 'Treasurer'], $user_role, $committee_role) ? 'style="display: none;"' : '' ?>>
